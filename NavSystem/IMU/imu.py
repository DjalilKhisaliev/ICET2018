...
class IMU(object):
    ...
    def read_all(self):
        ...
        return (self.pitch, self.roll, self.gyro_scaled_x, self.gyro_scaled_y, self.gyro_scaled_z, self.accel_scaled_x, self.accel_scaled_y, self.accel_scaled_z)       # return (self.accel_scaled_x, self.accel_scaled_y, self.accel_scaled_z)
